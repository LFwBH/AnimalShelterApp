...
export default function PetsScreen({ }: ChatScreenProps) {
  ...
  const steps = [
    ...
    {
      id: '1',
      message: 'Это чат-бот приюта "Маленькие друзья с большим сердцем". Чем я могу помочь?',
      trigger: '2',
    },
    {
      id: '2',
    ...
    {
      id: '3',
      message: 'Зайдите в карточку выбранного питомца и заполните анкету. Мы с вами свяжемся.',
      trigger: '2',
    },
    {
      id: '4',
      message: 'Мы принимаем гостей по выходным. Напишите, когда вам удобно и оставьте свой номер телефона. Мы с вами свяжемся.',
      trigger: '2',
    },
    {
      id: '5',
  ...
  return (
    <Box as={SafeAreaView} flex={1}>
      <ChatBot steps={steps} footerStyle={{display: 'none'}}optionFontColor='#000' optionBubbleColor="#fff" />
    </Box>
  );
}
